...
var JFlowEvent = /*#__PURE__*/function (_CustomEvent) {
  _inherits(JFlowEvent, _CustomEvent);

  var _super = _createSuper(JFlowEvent);

  function JFlowEvent(event) {
    var configs = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, JFlowEvent);
  ...
  return _createClass(JFlowEvent);
}( /*#__PURE__*/_wrapNativeSuper(CustomEvent));

var _default = JFlowEvent;

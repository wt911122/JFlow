 ...
 * @mixes GroupMixin
 */
var RhombusGroup = /*#__PURE__*/function (_Rhombus) {
  _inherits(RhombusGroup, _Rhombus);

  var _super = _createSuper(RhombusGroup);

  function RhombusGroup(configs) {
    var _this;

    _classCallCheck(this, RhombusGroup);
  ...
  _createClass(RhombusGroup, [{
    key: "render",
    value: function render(ctx) {
      var _this2 = this;

      this.renderGroup(ctx, function () {
        _rhombus["default"].prototype.render.call(_this2, ctx); // this.backgroundColor = 'rgba(0,0,0,0.2)';
    ...
    value: function isHit(point, condition) {
      ...
      return _rhombus["default"].prototype.isHit.call(this, point);
    }
  }]);
...
Object.assign(RhombusGroup.prototype, _groupMixin["default"]);
var _default = RhombusGroup;
exports["default"] = _default;
//# sourceMappingURL=rhombus-group.js.map
